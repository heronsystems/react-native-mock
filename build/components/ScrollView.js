...
var ScrollView=(0,_createReactClass2['default'])({displayName:'ScrollView',
propTypes:_extends({},
...
/**
     ...
     * @platform ios
     */
decelerationRate:_propTypes2['default'].oneOfType([_propTypes2['default'].oneOf(['fast','normal']),_propTypes2['default'].number]),
/**
...
_ScrollViewManager2['default'].endRefreshing(_react2['default'].findNodeHandle(this));
}return endRefreshin;}(),

scrollTo:function(){function scrollTo(){var destY=arguments.length>0&&arguments[0]!==undefined?arguments[0]:0;var destX=arguments.length>1&&arguments[1]!==undefined?arguments[1]:0;var animated=arguments.length>2&&arguments[2]!==undefined?arguments[2]:true;}return scrollTo;}(),
