...
var TextInput=(0,_createReactClass2['default'])({displayName:'TextInput',
propTypes:_extends({},
...
/**
     ...
     * @platform ios
     */
keyboardAppearance:_propTypes2['default'].oneOf(['default','light','dark']),
/**
...
/**
     ...
     * @platform ios
     */
clearButtonMode:_propTypes2['default'].oneOf(['never','while-editing','unless-editing','always']),
/**
...
return _TextInputState2['default'].currentlyFocusedField()===_react2['default'].findNodeHandle(this.refs.input);
}return isFocused;}(),
