...
/**
   ...
   */
fontWeight:_propTypes2['default'].oneOf(['normal','bold','100','200','300','400','500','600','700','800','900']),
...
/**
   ...
   */
textAlign:_propTypes2['default'].oneOf(['auto','left','right','center','justify']),
/**
   * @platform android
   */
textAlignVertical:_propTypes2['default'].oneOf(['auto','top','bottom','center']),
/**
   * @platform ios
   */
textDecorationLine:_propTypes2['default'].oneOf(['none','underline','line-through','underline line-through']),
/**
   * @platform ios
   */
textDecorationStyle:_propTypes2['default'].oneOf(['solid','double','dotted','dashed']),
/**
   * @platform ios
   */
...
/**
   * @platform ios
   */
writingDirection:_propTypes2['default'].oneOf(['auto','ltr','rtl'])});
